...
For example, if I want to run `index.js` in the first session I would:

1. Navigate to the correct folder: `cd week1/session1-api`
1. Install dependencies: `npm i`
1. Run the code `node index.js` (or `node --watch index.js` if I want changes to be automatically reloaded)
